...
void printZone(std::ostream& oOut, const FofiModel::DirectoryZone& oDZ)
{
...
void printZoneJSon(std::ostream& oOut, const FofiModel::DirectoryZone& oDZ)
{
...
void printDetailResultJSon(std::ostream& oOut, const FofiModel::WatchedResult& oResult, int64_t nDurationUsec, json& oJRes)
{
...
void printCodeLiveAction(std::ostream& oOut, const FofiModel::WatchedResult& oResult)
{
