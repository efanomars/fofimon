...
def testAll(sBuildType, sDestDir, sSudo):
	...
	subprocess.check_call("./scripts/uninstall_fofimon.py -r -y --destdir {}  {}".format(sDestDir, sSudo).split())

	subprocess.check_call("./scripts/install_fofimon.py -b {} -t On  --destdir {}  {}"\
