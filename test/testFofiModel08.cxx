...
{
	std::cout << "FofiModel08 Tests:" << '\n';

	EXECUTE_TEST(fofi::testing::testDeepRename());
	//
	std::cout << "FofiModel08 Tests successful!" << '\n';
	return 0;
}
