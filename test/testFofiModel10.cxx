...
int testDeepRenameAndBackNoSleep()
{
...
{
	std::cout << "FofiModel10 Tests:" << '\n';

	EXECUTE_TEST(fofi::testing::testDeepRenameAndBackNoSleep());
	//
	std::cout << "FofiModel10 Tests successful!" << '\n';
	return 0;
}
