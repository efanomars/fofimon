...
{
	std::cout << "FofiModel06 Tests:" << '\n';

	EXECUTE_TEST(fofi::testing::testDeepDirectoryCreation());
	//
	std::cout << "FofiModel06 Tests successful!" << '\n';
	return 0;
}
